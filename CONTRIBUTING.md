# Contributing to AsBuiltReport.DellEMC.VxRail
...
1. **Read the documentation** - Check the `README` in the AsBuiltReport.DellEMC.VxRail repository, including Supported Versions, System Requirements, and Module Installation sections.
...
- Software versions:
  - AsBuiltReport module versions (e.g., AsBuiltReport.Core v1.6.4)
...
2. Clone your fork and add the upstream remote:
   ```bash
   git clone https://github.com/<your-username>/AsBuiltReport.DellEMC.VxRail
   cd AsBuiltReport.DellEMC.VxRail
   git remote add upstream https://github.com/AsBuiltReport/AsBuiltReport.DellEMC.VxRail
   ```
...
- Raise an issue in the AsBuiltReport.DellEMC.VxRail [repository](https://github.com/AsBuiltReport/AsBuiltReport.DellEMC.VxRail)
